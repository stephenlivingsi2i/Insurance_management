...
urlpatterns = [
    ...
    path('getParticularOrganizationInsuranceClaim/<int:organization_id>/<int:employee_id>/',
         views.get_particular_organization_insurance_claim,
         name='get_particular_organization_insurance_claim'),
